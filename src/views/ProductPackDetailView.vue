            ...
            <div class="row g-4">
                <div class="col-md-6 d-flex justify-content-center justify-content-md-end">
                    <div class="card card-product-detail bg-secondary-subtle border-0 rounded-4">
                        <img :src="ImgTraLaiHopGiay" alt="">
                    </div>
                </div>
                <div class="col-md-6 col-xl-5">
                    <h4 class="text-success">Trà Ô Long Dâu (L)</h4>
                    <div>SKU: 65000107</div>
                    <div class="badge text-bg-danger text-uppercase">best seller</div>
                    <div class="d-flex justify-content-between mt-3">
                        <h4 class="text-success">75.000 đ</h4>
                        <QuantityButton />
                    </div>
                    <div class="row mb-3">
...
import ImgTraLaiHopGiay from '../assets/images/tra-lai-hop-giay.png';
