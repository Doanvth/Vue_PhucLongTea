...
var defaultType = {
  ...
  compare(x2, y3) {
    function cook(d3) {
      ...
      return diacriticless(String(d3).toLowerCase());
    }
    x2 = cook(x2);
    y3 = cook(y3);
    if (x2 < y3) return -1;
      ...
      createBaseVNode("form", null, [
        ...
        withDirectives(createBaseVNode("select", {
          ...
          $props.paginateDropdownAllowAll ? (openBlock(), createElementBlock("option", {
            key: 0,
            value: $props.total
          }, toDisplayString($props.allText), 9, _hoisted_6$4)) : createCommentVNode("v-if", true)
        ], 40, _hoisted_4$5), [
...
var _hoisted_4$4 = ["id", "placeholder", "value"];
var _hoisted_5$4 = { class: "vgt-global-search__actions vgt-pull-right" };
  ...
  return $options.showControlBar ? (openBlock(), createElementBlock("div", _hoisted_1$4, [
    createBaseVNode("div", _hoisted_2$4, [
      $props.searchEnabled ? (openBlock(), createElementBlock(
        ...
        [
          createBaseVNode("label", { for: $data.id }, _cache[3] || (_cache[3] = [
            createBaseVNode(
              "span",
              {
                "aria-hidden": "true",
                  ...
                  $options.isFilterable(column) ? (openBlock(), createElementBlock("div", _hoisted_5$3, [
                    ...
                    $options.isDropdownArray(column) ? (openBlock(), createElementBlock("select", {
                      ...
                      (openBlock(true), createElementBlock(
                        Fragment,
                        null,
                        renderList(column.filterOptions.filterDropdownItems, (option, i2) => {
                          return openBlock(), createElementBlock("option", {
                            key: i2,
                            value: option
...
function getIndex(sortArray, column) {
  for (let i2 = 0; i2 < sortArray.length; i2++) {
    if (column.field === sortArray[i2].field) return i2;
  }
  return -1;
}
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("tr", null, [
    ...
    (openBlock(true), createElementBlock(
      Fragment,
      null,
      renderList($props.columns, (column, i2) => {
        return openBlock(), createElementBlock(
          Fragment,
          { key: i2 },
          [
            $props.headerRow.mode !== "span" && !column.hidden ? (openBlock(), createElementBlock("th", {
              ...
              $options.columnCollapsable(i2) ? (openBlock(), createElementBlock(
                "span",
                {
                  key: 0,
                  class: normalizeClass(["triangle", { "expand": $props.headerRow.vgtIsExpanded }])
...
date.isRight = true;
date.compare = function(x2, y3, column) {
  function cook(d3) {
    if (column && column.dateInputFormat) {
      return parse(`${d3}`, `${column.dateInputFormat}`, /* @__PURE__ */ new Date());
    } else if (typeof d3 === "string") {
      try {
        return Date.parse(d3);
      } catch (err) {
        return d3;
      }
    }
...
number.compare = function(x2, y3) {
  function cook(d3) {
    if (d3 === void 0 || d3 === null) return -Infinity;
    return d3.indexOf(".") >= 0 ? parseFloat(d3) : parseInt(d3, 10);
  }
  x2 = typeof x2 === "number" ? x2 : cook(x2);
  y3 = typeof y3 === "number" ? y3 : cook(y3);
  if (x2 < y3) return -1;
  if (x2 > y3) return 1;
  return 0;
};
...
boolean.compare = function(x2, y3) {
  function cook(d3) {
    if (typeof d3 === "boolean") return d3 ? 1 : 0;
    if (typeof d3 === "string") return d3 === "true" ? 1 : 0;
    return -Infinity;
  }
  x2 = cook(x2);
  y3 = cook(y3);
    ...
    processedRows() {
      ...
      if (this.globalSearchAllowed) {
        ...
        this.filteredRows.forEach((headerRow) => {
          ...
          const children = filteredRows.filter((r) => r.vgt_id === i2);
          if (children.length) {
  ...
  methods: {
    ...
    getColumnForField(field) {
      for (let i2 = 0; i2 < this.typedColumns.length; i2 += 1) {
        if (this.typedColumns[i2].field === field) return this.typedColumns[i2];
      }
    },
    handleSearch() {
      this.resetTable();
    ...
    filterRows(columnFilters, fromFilter = true) {
      ...
      if (instancesOfFiltering) {
        this.filteredRows = computedRows.filter(
          (h3) => h3.children && h3.children.length
        );
      } else {
        this.filteredRows = computedRows;
      }
...
var _hoisted_2 = { class: "vgt-selection-info-row__actions vgt-pull-right" };
var _hoisted_3 = { class: "vgt-fixed-header" };
var _hoisted_4 = ["id"];
var _hoisted_5 = ["id"];
var _hoisted_6 = ["onMouseenter", "onMouseleave", "onDblclick", "onClick", "onAuxclick"];
var _hoisted_7 = {
  key: 0,
  class: "line-numbers"
};
var _hoisted_8 = ["onClick"];
var _hoisted_9 = ["disabled", "checked"];
var _hoisted_10 = ["onClick", "data-label"];
    ...
    [
      ...
      createBaseVNode(
        ...
        [
          ...
          _ctx.alwaysShowSelectionInfo || $options.selectedRowCount && !_ctx.disableSelectInfo ? (openBlock(), createElementBlock(
            "div",
            {
              key: 1,
            ...
            [
              createBaseVNode(
                ...
                [
                            ...
                            return openBlock(), createElementBlock(
                              ...
                              [
                                ...
                                row["expanded"] ? (openBlock(), createElementBlock("tr", {
                                  ...
                                  createBaseVNode("td", { colspan: $options.fullColspan }, toDisplayString(row["expandedRow"]), 9, _hoisted_14)
                                ])) : createCommentVNode("v-if", true)
                              ],
                              64
                              /* STABLE_FRAGMENT */
                  ...
                  $options.showEmptySlot ? (openBlock(), createElementBlock("tbody", _hoisted_15, [
                    createBaseVNode("tr", null, [
                      createBaseVNode("td", { colspan: $options.fullColspan }, [
